...
APP_ID: int = int(os.getenv("APP_ID", 22808125))
APP_HASH = os.getenv("APP_HASH", "406c09543fec722fe3c48ca2f06d78de")
TOKEN = os.getenv("TOKEN", "6540495466:AAFpWpPyEswthHQEYnELkY2eUunLQINi9r8")
